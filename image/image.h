...
private:
    ...
    int cols;                   ///< Nr of columns in image
    int rows;                   ///< Nr of rows in image
...
public:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////
    void write_header(const imtype _type, const int _rows, const int _cols, const int _maxval, const string comments)
    {
        type   = _type;
        rows   = _rows;
        cols   = _cols;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////
    bool write(std::string fname, const imtype _type, arma::cube& img, const string info="")
    {
     // Open file
